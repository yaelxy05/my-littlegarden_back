 ...
 */
final class Version20220404084244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE plant ADD potager_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE potager ADD user_id INT NOT NULL');
        $this->addSql('ALTER TABLE potager ADD CONSTRAINT FK_EC7736E4A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_EC7736E4A76ED395 ON potager (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_EC7736E4A76ED395 ON potager');
        $this->addSql('ALTER TABLE potager DROP user_id');
    }
}
